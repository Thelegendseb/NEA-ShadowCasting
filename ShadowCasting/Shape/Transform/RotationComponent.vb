Public Class RotationComponent
    ...
    Public Function YawToDegrees() As Decimal
        Return Me.Yaw * (180 / Math.PI)
    End Function
    Public Function RollToDegrees() As Decimal
        Return Me.Roll * (180 / Math.PI)
    End Function
    Public Function PitchToDegrees() As Decimal
